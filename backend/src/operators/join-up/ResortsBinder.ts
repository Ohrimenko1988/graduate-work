export class ResortsBinder {
    ...
    constructor() {
        // Turkiye
        this.resortsDefinitions.set("Алания", [339, 1573, 1572, 1574, 1766, 1575, 1576, 1577, 1578, 1579, 1580]);
        this.resortsDefinitions.set("Анталия", [10, 26, 2502, 1582, 1583, 1581]);
        ...
        this.resortsDefinitions.set("Шарм Єль Шейх", [17, 1360, 1347, 1843, 2380, 1841, 1844, 1845, 1846, 1850, 1840, 1839, 1849]);
        ...
        this.resortsDefinitions.set("Тенерифе", [105, 222, 2655, 328, 847, 754, 327, 513, 335, 852]);
    }
